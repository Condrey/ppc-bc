...
import FormAddEditBuildingInspection from "./form-edit-building-inspection";

interface Props extends ButtonProps {
  buildingApplication: InspectionBuildingApplicationData;
  inspection: InspectionData;
}
export default function ButtonEditBuildingInspection({
  buildingApplication,
  inspection,
  ...props
}: Props) {
