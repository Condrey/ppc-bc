...
export default function ButtonAddAbsentee({
  thisForm: form,
  committeeMembers,
  ...props
}: Props) {
  ...
  const fields = form.getValues("absentMembersWithApology");
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button title={"Add absentee"} {...props} onClick={onButtonClick} />
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
                ...
                return (
                  <CommandItem
                    ...
                    onSelect={() => {
                      if (!wasSelected) {
                        append({ id: member.id });
                        form.clearErrors("absentMembersWithApology");
                        // setOpen(false);
                      }
                    }}
                  >
